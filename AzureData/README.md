...
#### Delete
```swift
AzureData.delete (trigger, fromCollection: collectionId, inDatabase: databaseId) { r in
    // r.isSuccess == successfully deleted
}

AzureData.delete (trigger, fromCollection: collection) { r in
    // r.isSuccess == successfully deleted
}
...
AzureData.replace (triggerWithId: triggerId, triggerResourceId: triggerResourceId, operation: .all, type: .pre, andBody: body, inCollection: collection) { r in
    // trigger = r.resource
}
...
collection.replace (triggerWithId: triggerId, triggerResourceId: triggerResourceId, operation: .all, type: .pre, andBody: body) { r in
    // trigger = r.resource
}

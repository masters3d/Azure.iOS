...
class TriggerTests: AzureDataTests {
    ...
    func testTriggerCrud() {
        ...
        AzureData.replace(triggerWithId: newResourceId, triggerResourceId: resourceId, operation: .all, type: .post, andBody: "function updateMetadata()", in: collection!) { r in
            replaceResponse = r
        ...
        // Delete
        AzureData.delete (triggerWithId: newResourceId, fromCollection: collection!) { r in
            deleteResponse = r
